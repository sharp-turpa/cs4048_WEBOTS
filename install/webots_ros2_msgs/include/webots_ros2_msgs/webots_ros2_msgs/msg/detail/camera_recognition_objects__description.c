  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xc7, 0x86, 0xa7, 0x7c, 0xd4, 0xa8, 0xd5, 0x7f,
      0xb8, 0xc0, 0xdf, 0x84, 0xa0, 0x39, 0x3c, 0x15,
      0x23, 0x37, 0x32, 0x50, 0x5b, 0x0e, 0xc4, 0xdb,
      0xf6, 0x73, 0x53, 0xcd, 0xa5, 0x91, 0xd6, 0x51,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t webots_ros2_msgs__msg__CameraRecognitionObject__EXPECTED_HASH = {1, {
    0x1a, 0x6f, 0xc4, 0xd2, 0xab, 0xd7, 0x92, 0xc0,
    0xac, 0xfb, 0x67, 0x66, 0xd6, 0xda, 0x7c, 0x25,
    0x2f, 0x92, 0x61, 0xdf, 0x62, 0x35, 0x97, 0x4c,
    0x52, 0x5d, 0x79, 0xe2, 0xb7, 0xb9, 0x51, 0x11,
  }};
#endif

static char webots_ros2_msgs__msg__CameraRecognitionObjects__TYPE_NAME[] = "webots_ros2_msgs/msg/CameraRecognitionObjects";
...
static char webots_ros2_msgs__msg__CameraRecognitionObject__TYPE_NAME[] = "webots_ros2_msgs/msg/CameraRecognitionObject";

// Define type names, field names, and default values
static char webots_ros2_msgs__msg__CameraRecognitionObjects__FIELD_NAME__header[] = "header";
static char webots_ros2_msgs__msg__CameraRecognitionObjects__FIELD_NAME__objects[] = "objects";

static rosidl_runtime_c__type_description__Field webots_ros2_msgs__msg__CameraRecognitionObjects__FIELDS[] = {
  {
    {webots_ros2_msgs__msg__CameraRecognitionObjects__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {webots_ros2_msgs__msg__CameraRecognitionObjects__FIELD_NAME__objects, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {webots_ros2_msgs__msg__CameraRecognitionObject__TYPE_NAME, 44, 44},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription webots_ros2_msgs__msg__CameraRecognitionObjects__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {webots_ros2_msgs__msg__CameraRecognitionObjects__TYPE_NAME, 45, 45},
      {webots_ros2_msgs__msg__CameraRecognitionObjects__FIELDS, 2, 2},
    },
    {webots_ros2_msgs__msg__CameraRecognitionObjects__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[9].fields = vision_msgs__msg__Pose2D__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&webots_ros2_msgs__msg__CameraRecognitionObject__EXPECTED_HASH, webots_ros2_msgs__msg__CameraRecognitionObject__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[10].fields = webots_ros2_msgs__msg__CameraRecognitionObject__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
webots_ros2_msgs__msg__CameraRecognitionObjects__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *webots_ros2_msgs__msg__CameraRecognitionObjects__get_individual_type_description_source(NULL),
    ...
    sources[10] = *vision_msgs__msg__Pose2D__get_individual_type_description_source(NULL);
    sources[11] = *webots_ros2_msgs__msg__CameraRecognitionObject__get_individual_type_description_source(NULL);
    constructed = true;
  }
