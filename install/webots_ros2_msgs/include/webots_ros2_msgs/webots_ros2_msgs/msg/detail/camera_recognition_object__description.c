...
static char webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__id[] = "id";
static char webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__pose[] = "pose";
static char webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__bbox[] = "bbox";
static char webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__colors[] = "colors";
static char webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__model[] = "model";

static rosidl_runtime_c__type_description__Field webots_ros2_msgs__msg__CameraRecognitionObject__FIELDS[] = {
  {
    {webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__bbox, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__colors, 6, 6},
    {
  ...
  {
    {webots_ros2_msgs__msg__CameraRecognitionObject__FIELD_NAME__model, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription webots_ros2_msgs__msg__CameraRecognitionObject__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {webots_ros2_msgs__msg__CameraRecognitionObject__FIELDS, 5, 5},
    },
    {webots_ros2_msgs__msg__CameraRecognitionObject__REFERENCED_TYPE_DESCRIPTIONS, 10, 10},
  };
  if (!constructed) {
...
webots_ros2_msgs__msg__CameraRecognitionObject__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *webots_ros2_msgs__msg__CameraRecognitionObject__get_individual_type_description_source(NULL),
